...
```lua
{
  ...
  env = {
    ...
    REVERSE = "--reverse",
    MENU = " MENU",
    MENU_EXPLORER = "󰙅 EXPLORER",
    MENU_SEARCH_DIRECTORIES_AND_FILES = "󱋣 SEARCH DIRECTORIES AND FILES",
    MENU_SEARCH_DIRECTORIES = "󰉋 SEARCH DIRECTORIES",
    MENU_SEARCH_FILES = "󰈔 SEARCH FILES",
    MENU_SEARCH_IN_FILES = "󰈙 SEARCH IN FILES",
    ICON_POINTER = "",
    ICON_MARKER = "",
    ICON_PROMPT = "",
    ICON_SEPARATOR = "",
