local config = {
    ...
    env = {
        ...
        ICON_PROMPT = "",
        ICON_SEPARATOR = "",
        EXPLORER = "eza --group --colour=always --icons=always --group-directories-first --classify --level --oneline",
        ...
        SEARCH_IN_FILES_WITH_OUT_HIDDEN = "rg --no-heading -H --smart-case --line-number --column --follow"
            .. " --color=always",
        COLORS = "fg:#448589,bg:#141819,hl:#C94233,fg+:#448589,bg+:#181d1f,hl+:#C94233,pointer:#C94233,info:#E58C26,gutter:#141819,spinner:#E58C26,header:#C94233,prompt:#7F9858,marker:#C94233",
        KEY_QUIT = "ctrl-q",
        KEY_CLEAR_QUERY = "esc",
